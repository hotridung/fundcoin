...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Fundcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"funcoin.ga", "34.87.73.51"},
	{"funcoin.ml", "35.198.213.220"},
	{NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    0x0100007f,0xdcd5c623,0x33495722
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Fundcoin is probably already running."), addrBind.ToString().c_str());
        else
